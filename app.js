...
app.get('/d',(req,res)=>{
    ...
    app.post('/done', (req, res)=>{
        ...
        let query1 = `Insert into asset.dbo.Users (user_id,user_name,email,password,user_type,Parent_org) VALUES ('${empid}','${username}','${email}','${hash}','${user}','${parental}')`; 
  ...
  const{asset_name,asset_type,asset_id,location_name}=req.body
    ...
    let queryResult = mssql.query(query, (err, result) => {
        ...
        if (err) {
            ...
            console.log('updation has been done')  
            res.send({
